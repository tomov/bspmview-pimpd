...
function cb_correct(varargin)
    ...
    [st.ol.C0, st.ol.C0IDX] = getclustidx(st.ol.Y, T.thresh, T.extent);
    C = st.ol.C0(di,:);
    save('~/Downloads/bspm_correct.mat');
    disp('correct');
    if sum(C(C>=T.extent))==0
        T0.thresh = st.ol.U;
        setthreshinfo(T0);
...
disp('SMOOTH!');
save('~/Downloads/bspm_smooth.mat');
st.ol.Y = y;
cb_updateoverlay
setstatus('Ready');
...
function cb_savetable(varargin)
    ...
    disp('savetable!');
    save('~/Downloads/bspm_savetable.mat');
...
function cb_montage(varargin)
    ...
    opt = [1 -1 1];
disp('MONGATE!');
save('~/Downloads/bspm_montage.mat');
...
function setmaxima
    ...
    save('~/Downloads/bspm_setmaxima.mat');
    disp('set maxima!');
